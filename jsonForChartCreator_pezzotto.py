        ...
        for j in RFDstoTest:
            if i.RHS == j.RHS:
                if(i.LHS == j.LHS):
                    ...
                    if i.label_attributi == j.label_attributi:
                        ...
                        if np.all(differenze_lhs >= 0) and np.any(differenze_lhs > 0):  #caso generalizzazione con lhs più grande
                            ...
                            if len(arrayTmp) != 0:
                                ...
                                genMap["children"].append(copy.copy(RHSoriginali))
                            # print(genMap)
                        elif(np.all(differenze_lhs <= 0) and np.any(differenze_lhs < 0)):   # caso specializzazione con lhs più piccolo
            ...
            #riprendere da qui
                ...
                if i.LHS == j.LHS:
                    # caso generalizzazione con rhs più piccolo e lhs uguale
                    if j.RHS[1] < i.RHS[1]:
                        print("trovata generalizzazione su soglie rhs")
                        l2 = list(j.stampaLHS)
                        j.found = True
                        i.found = True
                        tmp = {"RHS": j.stampaRHS, "LHS ": l2}
                        ...
                        if len(arrayTmp) != 0:
                            ...
                            genMap["children"].append(copy.copy(RHSoriginali))
                        # print(genMap)
                    # caso specializzazione con lhs uguale e rhs più grande
                    elif(j.RHS[1] > i.RHS[1]): # caso specializzazione con lhs uguale e rhs più grande
                        print("trovata specializzazione su soglie rhs")
                        l2 = list(j.stampaLHS)
                        j.found = True
                        i.found = True
                        tmp = {"RHS": j.stampaRHS, "LHS": l2}
                ...
                else:  #caso generalizzazione con rhs più piccolo e lhs più grande
                    if j.RHS[1] < i.RHS[1]:
                        differenze_lhs = j.thres_attributi - i.thres_attributi
                        if np.all(differenze_lhs >= 0) and np.any(differenze_lhs > 0):
                            print("trovata generalizzazione su soglie rhs e soglie lhs")
                            l2 = list(j.stampaLHS)
                            j.found = True
                            i.found = True
                            tmp = {"RHS": j.stampaRHS, "LHS ": l2}
                            ...
                            if len(arrayTmp) != 0:
                                ...
                                genMap["children"].append(copy.copy(RHSoriginali))
                            # print(genMap)
                    elif(j.RHS[1] > i.RHS[1]):
                        if len(j.thres_attributi)==len(i.thres_attributi):
                            differenze_lhs = j.thres_attributi - i.thres_attributi
                            if np.all(differenze_lhs <= 0) and np.any(differenze_lhs < 0):
                                print("trovata specializzazione su soglie rhs e soglie lhs")
                                l2 = list(j.stampaLHS)
                                j.found = True
                                i.found = True
                                tmp = {"RHS": j.stampaRHS, "LHS": l2}
